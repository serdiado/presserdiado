...
const MODULES: StudioModule[] = [
  // ── Gerçek sistem modülleri (stüdyoda tasarlanıp "Modül Kopyala" ile dışa aktarıldı) ──
  // JSON import literal tipleri genişlettiğinden union'lara uymaz → as unknown as ile cast; kimlik ezilir.
  {
    ...(afpackBanner as unknown as StudioModule),
    id: 'module-afpack-banner',
    name: 'AfPack Banner',
    description: 'Selbstabholer üst bandı — logo, kampanya tarihi ve slogan (5×5).',
  },
  {
    ...(afpackPizza as unknown as StudioModule),
    id: 'module-afpack-pizza-karton',
    name: 'AfPack Pizza Karton',
    description: 'Pizza karton boyut/fiyat tablosu — üst karakterli fiyatlar + ürün görseli (4×9).',
  },

  // ── Banner placeholder'ları — FreeStudioModule, type:'banner' ──
  phBanner(
    'module-banner-donem',
    'Dönem Fırsatı',
