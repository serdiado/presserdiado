...
export const defaultLightTheme: UIThemeTokens = {
  ...
  typography: {
    ...
    navLabel:  { fontSize: '0.8125rem',  fontWeight: '400', lineHeight: '1.4',  letterSpacing: '0em'     },
    headingMd: { fontSize: '0.8125rem',  fontWeight: '600', lineHeight: '1.4',  letterSpacing: '0em'     },
    headingSm: { fontSize: '0.8125rem', fontWeight: '600', lineHeight: '1.4',  letterSpacing: '0em'     },
    ...
    labelSm:   { fontSize: '0.75rem',   fontWeight: '600', lineHeight: '1.4',  letterSpacing: '0em'     },
