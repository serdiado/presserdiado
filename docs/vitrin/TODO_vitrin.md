...
- [ ] **Broşür → turmatsan verisi + facet** — şu an bizim uydurma seçeneklerimizle duruyor (stüdyo/sihirbaz ona bağlı, DİKKAT). Turmatsan broşürü temiz matris: kağıt hattı (115/128/200-selefon) × ebat (gerçek cm) × adet. `design` modu olduğu için ebat `affectsDesign` — stüdyoya girişi ayrı test edilmeli.
