...
//
// Tasarım referansı: ui_kits/kullanici-paneli/Pages.jsx → Projelerim
...
export function Projelerim({ projects, total, loading, onNewDesign }: ProjelerimProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-8">
      ...
      {loading ? (
        ...
        <EmptyState onNewDesign={onNewDesign ?? (() => navigate('/new'))} />
      ) : (
