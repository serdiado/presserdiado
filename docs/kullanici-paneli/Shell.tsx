...
//
// Tasarım referansı: ui_kits/kullanici-paneli/Shell.jsx
// Codebase'ten türetildi: apps/web/src/features/auth/Layout.tsx
...
// Route map — projeye göre düzenleyin
export const NAV_ROUTES: Record<NavItemId, string> = {
  home:      '/dashboard',
  projects:  '/dashboard/projeler',
  templates: '/dashboard/sablonlar',
  lists:     '/dashboard/urun-listeleri',
  brand:     '/dashboard/marka',
  orders:    '/dashboard/siparisler',
  files:     '/dashboard/dosyalar',
  team:      '/dashboard/ekip',
  billing:   '/dashboard/fatura',
  account:   '/dashboard/ayarlar',
  help:      '/dashboard/yardim',
};
  ...
  return (
    <header className="h-14 bg-white border-b border-slate-200 flex items-center px-6 shrink-0">
      ...
      <Link to="/dashboard" className="flex items-center gap-2">
        {/* Logo mark — gerçek SVG/img ile değiştirin */}
...
function DashboardSideNav({
  ...
  // Aktif route'dan active id bul
  const activeId = (Object.entries(NAV_ROUTES).find(
